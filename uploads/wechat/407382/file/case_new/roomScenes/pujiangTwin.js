...
let roomId = "040002010000000011852305";
// 机柜、设备相关全局变量
...
//   [
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/common/common.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Button_control/js/Button_control.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Button_control/index.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Switch_control_vs1/js/Switch_vs1.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Switch_control_vs1/index.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Camerafly/js/Camerafly.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Camerafly/index.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Switch_control_vs2/index.js",
//     "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Switch_control_vs2/js/Switch_vs2.js",
//     // "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Panel/js/Panel.js",
//     // "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Panel/index.js",
//     // "/uploads/wechat/407382/file/case_new/ElectronicCabinet/business/Panel/css/panel.css",
//     //按钮教程
...
//加载配电柜下钻资源文件
// THING.Utils.dynamicLoad([
//   "/uploads/wechat/407382/file/case_new/ElectronicCabinet/index.js",
// ]);
// 加载本地、外部资源
THING.Utils.dynamicLoad(
  [
...
function createLedModel(d) {
  ...
  d.datas.records.forEach((i, index) => {
    ...
    if (i.isopen == "1" && i.lightingType == "2") {
      th1.style.outlineColor = "#ffffff";
      th1.style.color = "#ffffff";
      th1.style.emissive = "#ffffff";
    }
    // th1.rotateY(-90)
  });
...
function createInputPowerDistributionCabinet(d) {
  ...
  inputPowerData.forEach((i) => {
    ...
    var obj = app.create({
      ...
      url: i.modelName
        ? modelMatchingModel(i.modelName).modelUrl
...
function createPowerModel(d) {
  ...
  powerDataList.forEach((i) => {
    ...
    var ltItem = app.create({
      ...
      id: i.deviceId,
      name: "列头柜",
      // url: './models/D001C17E795F41CB9B86926D76DDA331/0/gltf/',
      // url: '/api/models/6A2C883C770B47719F4DA7137983254B/0/gltf/',
      // url: i.modelName == '040002010000000011852305' ? './models/DD497D1FFBD74220880AE376B4E810E7/0/gltf/' : '/api/models/20150730584999/0/gltf/',
...
function createPowerCabinetModel(d) {
  ...
  upsList.on("click", function (ev) {
    getAlarmInfoMessage(this.userData.deviceId);
    // THING.Utils.log(this.userData,'this.userDatathis.userDatathis.userDatathis.userData')
...
// ups根据模型名称替换
// 网络设备模型
function modelMatchingModel(modelName) {
  let obj = {
    scale: [],
    modelUrl: "",
  };
  ...
  switch (modelName) {
    ...
    case "3A45309974B54A359": // 端口箱
      ...
      obj.scale = [0.8 / 0.2, 1 / 0.3, 0.25 / 0.4];
      break;
    ...
    case "20160112233916016": // 梅河 UPS
      ...
      obj.scale = [1.2 / 0.8, 1.65, 0.85 / 0.96];
      break;
...
function floorEnter() {
  ...
  floors.forEach((i, index) => {
    i.position = [i.position[0], i.position[1] + index * 2, i.position[2]];
  });
