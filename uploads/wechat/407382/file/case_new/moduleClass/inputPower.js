/**
 * InputPower 监控平台输入配电柜
 */
class InputPower extends THING.Thing {
    constructor(app) {
        super(app);
        this.racks = [];
        this.isPower = true;
    ...
    showInputPowerName(boolValue){
        this.panel && (this.panel.visible = boolValue);
    }

}
THING.factory.registerClass('InputPower', InputPower);
InputPower.current = null;
InputPower.open = false;
