...
class Led extends THING.Thing {
    ...
    addMarket() {
        let url = this.userData.status == 1 ? '/uploads/wechat/407382/file/case_new/deng-liang.png' : '/uploads/wechat/407382/file/case_new/deng-mie.png'
    ...
    showLedName(boolValue) {
        this.panel && (this.panel.visible = boolValue);
    }
}
THING.factory.registerClass('Led', Led);
Led.current = null;
Led.open = false;
