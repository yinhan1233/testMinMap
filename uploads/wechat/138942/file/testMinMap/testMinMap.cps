...
*/
{
    ...
    //      为能正确打包该引用模型，需配置如下：
     "qcts": [
         "/api/chart/62c39bdbee63ce05082e4a60"
      ],
    ...
    // ],
     // 举例：项目中引用了单资源标识 "/Resources/senChart/admin/f5e187be77074a22833becd4e3492d8a"，
    //      为能正确打包该引用模型，需配置如下：
    // "bundles": [
    //     "/Resources/bundle/admin/RMK100000000187590"
    // ],
    // 举例：项目中引用了单资源地图 "/Resources/CityMap/admin/43933"，
    //      为能正确打包该引用模型，需配置如下：
    //"thms": [
    //        "/Resources/EffectTemplate/admin/3940"
    //]
